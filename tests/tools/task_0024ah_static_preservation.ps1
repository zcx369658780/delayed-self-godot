...
$baseline='2813d08bf65eae2ae0c528a4825bfc133d5cdb43'; $allowed=@('tests/presentation/task_0024ah_dynamic_lifecycle_signature_validation.gd','tests/presentation/task_0024ah_dynamic_lifecycle_signature_validation.gd.uid')
...
$bad=@($changed|Where-Object{$_ -notin $allowed -and $_ -notlike 'tests/tools/task_0024ah_*'})
$historical=@(git -C $RepositoryRoot ls-files 'tests/presentation/task_0024af_*' 'tests/presentation/task_0024ag_*' 'tests/tools/task_0024af_*' 'tests/tools/task_0024ag_*')
