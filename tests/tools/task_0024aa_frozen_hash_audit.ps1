...
$status = if ($repositoryMismatches.Count -eq 0 -and $externalMismatches.Count -eq 0 -and $headMismatches.Count -eq 0 -and $acceptedMismatches.Count -eq 0 -and $wrapperBlob -eq '5f14eb0feff903b40311c1c7283b20e2eabbffc2') { 'PASS' } else { 'DRIFT' }
$result = [ordered]@{
    schema_version = 1
    task = '0024AA'
    phase = $Phase
...
Write-Output ("TASK_0024AA_FROZEN_HASH_AUDIT_WRITTEN " + $output)
