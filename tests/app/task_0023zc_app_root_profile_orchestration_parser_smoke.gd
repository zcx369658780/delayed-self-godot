...
func _run() -> void:
	if AppRootScript == null or AppRootScene == null or LocalProfile == null or ProfileProgressAdapter == null:
		quit(1)
		return
	print("TASK_0023ZC_APP_ROOT_PROFILE_ORCHESTRATION_PARSER_SMOKE_PASS")
	quit(0)
